...
enum OperationTypes {
    ...
    OPERATION_TYPE_STRING_FIND = 41,
    OPERATION_TYPE_STRING_PAD_START = 42,
    OPERATION_TYPE_STRING_SPLIT = 43,
    OPERATION_TYPE_ARRAY_LENGTH = 44,
    OPERATION_TYPE_ARRAY_SLICE = 45
};
