...
enum OperationTypes {
    ...
    OPERATION_TYPE_MATH_SIN = 31,
    OPERATION_TYPE_MATH_COS = 32,
    OPERATION_TYPE_MATH_LOG = 33,
    OPERATION_TYPE_MATH_LOG10 = 34,
    OPERATION_TYPE_MATH_ABS = 35,
    OPERATION_TYPE_MATH_FLOOR = 36,
    OPERATION_TYPE_MATH_CEIL = 37,
    OPERATION_TYPE_MATH_ROUND = 38,
    OPERATION_TYPE_STRING_FIND = 39,
    OPERATION_TYPE_STRING_PAD_START = 40,
    OPERATION_TYPE_STRING_SPLIT = 41,
    OPERATION_TYPE_ARRAY_LENGTH = 42,
    OPERATION_TYPE_ARRAY_SLICE = 43
};
...
enum DropDownListActionParamsSystemStructureFields {
    ...
    SYSTEM_STRUCTURE_DROP_DOWN_LIST_ACTION_PARAMS_FIELD_VALUE = 2,
