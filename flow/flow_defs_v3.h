...
enum OperationTypes {
    ...
    OPERATION_TYPE_DATE_NOW = 28,
    OPERATION_TYPE_MATH_SIN = 29,
    OPERATION_TYPE_MATH_COS = 30,
    OPERATION_TYPE_MATH_LOG = 31,
    OPERATION_TYPE_MATH_LOG10 = 32,
    OPERATION_TYPE_MATH_ABS = 33,
    OPERATION_TYPE_MATH_FLOOR = 34,
    OPERATION_TYPE_MATH_CEIL = 35,
    OPERATION_TYPE_MATH_ROUND = 36,
    OPERATION_TYPE_STRING_FIND = 37,
    OPERATION_TYPE_STRING_PAD_START = 38,
    OPERATION_TYPE_STRING_SPLIT = 39,
    OPERATION_TYPE_ARRAY_LENGTH = 40,
    OPERATION_TYPE_ARRAY_SLICE = 41
};
