...
enum OperationTypes {
    ...
    OPERATION_TYPE_DATE_GET_YEAR = 37,
    OPERATION_TYPE_DATE_GET_MONTH = 38,
    OPERATION_TYPE_DATE_GET_DAY = 39,
    OPERATION_TYPE_DATE_GET_HOURS = 40,
    OPERATION_TYPE_DATE_GET_MINUTES = 41,
    OPERATION_TYPE_DATE_GET_SECONDS = 42,
    OPERATION_TYPE_DATE_FROM = 43,
    OPERATION_TYPE_MATH_SIN = 44,
    OPERATION_TYPE_MATH_COS = 45,
    OPERATION_TYPE_MATH_LOG = 46,
    OPERATION_TYPE_MATH_LOG10 = 47,
    OPERATION_TYPE_MATH_ABS = 48,
    OPERATION_TYPE_MATH_FLOOR = 49,
    OPERATION_TYPE_MATH_CEIL = 50,
    OPERATION_TYPE_MATH_ROUND = 51,
    OPERATION_TYPE_MATH_MIN = 52,
    OPERATION_TYPE_MATH_MAX = 53,
    OPERATION_TYPE_STRING_LENGTH = 54,
    OPERATION_TYPE_STRING_SUBSTRING = 55,
    OPERATION_TYPE_STRING_FIND = 56,
    OPERATION_TYPE_STRING_PAD_START = 57,
    OPERATION_TYPE_STRING_SPLIT = 58,
    OPERATION_TYPE_ARRAY_LENGTH = 59,
    OPERATION_TYPE_ARRAY_SLICE = 60,
    OPERATION_TYPE_ARRAY_ALLOCATE = 61,
    OPERATION_TYPE_ARRAY_APPEND = 62,
    OPERATION_TYPE_ARRAY_INSERT = 63,
    OPERATION_TYPE_ARRAY_REMOVE = 64,
    OPERATION_TYPE_ARRAY_CLONE = 65
};
